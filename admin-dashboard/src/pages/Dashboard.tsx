...
const Dashboard = () => {
  ...
  const stores: Store[] = storesData?.docs.map(doc => ({
    id: doc.id,
    name: doc.data().name,
  ...
  const QuickActionCard = ({ 
    ...
    return (
      <button
        onClick={onClick}
        className={`w-full p-4 rounded-xl border bg-gradient-to-br ${colorClasses[color]} transition-all duration-200 hover:scale-105 hover:shadow-md text-left`}
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-bold text-gray-900">Popular Items Today</h2>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8 text-gray-500">
              <Pizza className="h-12 w-12 mx-auto mb-2 text-gray-300" />
